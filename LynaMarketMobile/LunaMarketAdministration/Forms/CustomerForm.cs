...
namespace LunaMarketAdministration.Forms
{
    public partial class CustomerForm : Form
    {
        ...
        private async void ActionCustomerButtonOnClick(object sender, EventArgs e)
        {
            switch (actionDeliveryComboBox.SelectedIndex)
            {
                case 0:
                    ...
                    {
                        await Core.AddCustomer(loginTextBox.Text, passwordTextBox.Text, nameTextBox.Text, surnameTextBox.Text,
